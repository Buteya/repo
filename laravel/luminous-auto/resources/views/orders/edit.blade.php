            ...
            <div class="card-body">
                <form action="{{ route('orders.update', $order->id) }}" method="post">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('unitprice') is-invalid @enderror" id="unitprice" name="unitprice" value="{{ $product->unitprice }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('totalprice') is-invalid @enderror" id="totalprice" name="totalprice" value="{{ $product->totalprice }}">
